...
export class Initial1737248997199 implements MigrationInterface {
    name = 'Initial1737248997199'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "grades" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(50) NOT NULL, "value" double precision NOT NULL, "weight" integer NOT NULL, "parentId" uuid, "course_id" uuid, CONSTRAINT "PK_4740fb6f5df2505a48649f1687b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "courses" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "code" character varying(8) NOT NULL, "name" character varying(50) NOT NULL, "credits" integer NOT NULL, "report_id" uuid, CONSTRAINT "UQ_86b3589486bac01d2903e22471c" UNIQUE ("code"), CONSTRAINT "PK_3f70a487cc718ad8eda4e6d58c9" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "tasks" ADD CONSTRAINT "FK_2aa1797743af2b1dd7965a5d7dc" FOREIGN KEY ("grade_id") REFERENCES "grades"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "grades" ADD CONSTRAINT "FK_670a44072f08b9dadf912b32b29" FOREIGN KEY ("parentId") REFERENCES "grades"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "courses" ADD CONSTRAINT "FK_dff8a484e213fa804441de95275" FOREIGN KEY ("report_id") REFERENCES "reports"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
