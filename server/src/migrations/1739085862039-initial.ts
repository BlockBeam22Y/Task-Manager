...
export class Initial1739085862039 implements MigrationInterface {
    name = 'Initial1739085862039'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "courses" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "code" character varying(8) NOT NULL, "name" character varying(50) NOT NULL, "credits" integer NOT NULL, "order" integer NOT NULL, "report_id" uuid, CONSTRAINT "PK_3f70a487cc718ad8eda4e6d58c9" PRIMARY KEY ("id"))`);
        ...
        // Agregar claves foráneas con cascada
